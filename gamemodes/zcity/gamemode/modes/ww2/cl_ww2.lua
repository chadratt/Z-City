...
net.Receive("ww2_start", function()
	surface.PlaySound("ww2music/wawheartofthereich.mp3")
	zb.RemoveFade()
	playstart = true
	ended = nil

	sound.PlayFile("ww2_music/waw_heartofthereich.mp3", "noblock noplay", function(station)
...
local teams = {
	[0] = {
		objective = "Kill all the Germans",
		name = "An American",
		color1 = Color(180, 0, 0),
		color2 = Color(180, 0, 0)
	},
	[1] = {
		objective = "Kill all the Americans",
		name = "A German",
...
function MODE:HUDPaint()
	...
	local timeBeforeSWAT = (zb.ROUND_START - CurTime() + 180)
	if timeBeforeSWAT > 0 and zb.ROUND_START + 10.5 < CurTime() then
		...
		surface.DrawText("time left before German reinforcements arrive!")
	...
	draw.SimpleText("WORLD WAR 2 TDM", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
