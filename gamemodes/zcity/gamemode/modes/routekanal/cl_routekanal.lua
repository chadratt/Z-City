MODE.name = "routekanal"

local MODE = MODE

net.Receive("routekanal_start",function()
    surface.PlaySound("hl2mode1.wav")
	zb.RemoveFade()
	timer.Simple(3, function()
		sound.PlayFile( "sound/routekanal/CPviolation.mp3", "mono noblock", function( station )
...
local teams = {
	...
	[1] = {
        ...
        name = "a Civil Protection Officer",
        name_elite = "a Civil Protection Officer",
        name_shotgunner = "a Civil Protection Officer",
...
function MODE:HUDPaint()
    ...
    draw.SimpleText("Route Kanal", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
net.Receive("routekanal_roundend", function()
