...
net.Receive("mafiawars_start", function()
...
local teams = {
	[0] = {
		objective = "These cops got the Don!",
		name = "an Italian Mafia Member",
		color1 = Color(180, 0, 0),
		color2 = Color(180, 0, 0)
	},
	[1] = {
		objective = "These Mafia pricks are gonna get what they deserve",
...
function MODE:HUDPaint()
	...
	draw.SimpleText("Mafia Wars", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
local CreateEndMenu
net.Receive("mafiawars_roundend", function()
	ended = true
	CreateEndMenu()
end)
