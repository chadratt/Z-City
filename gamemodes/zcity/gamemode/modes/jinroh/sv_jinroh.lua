...
util.AddNetworkString("jinroh_start")
...
function MODE:GiveEquipment()
	timer.Simple(0.5,function()
		...
		for i, ply in player.Iterator() do
			...
			if ply:Team() == 0 then
				timer.Create("SWATSpawn" .. ply:EntIndex(), 30, 1, function()
					...
					ply:SetPlayerClass("WolfBrigade")
					...
					zb.GiveRole(ply, "Jin Roh", Color(0,0,190))
				...
				zb.GiveRole(ply, "The Sect", Color(190,0,0))
		...
		timer.Create("SWATSpawn",30,1,function()
...
util.AddNetworkString("jinroh_end")
