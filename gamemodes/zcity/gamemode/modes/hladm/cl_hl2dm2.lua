...
net.Receive("hl2dm2_start",function()
    surface.PlaySound("hl2mode1.wav")
	zb.RemoveFade()
	timer.Simple(3, function()
		sound.PlayFile( "sound/combinehlamusic/Orbifold.mp3", "mono noblock", function( station )
...
local teams = {
	[0] = {
		objective = "Kill all Combine and survive.",
		name = "a Rebel",
	...
	[1] = {
        objective = "Amputate and destroy the Lambda forces.",
        name = "a Combine Soldier",
        name_elite = "the Captain Combine soldier",
...
function MODE:HUDPaint()
    ...
    draw.SimpleText("Half Life Alyx Deathmatch", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
