MODE.name = "hladm"
MODE.PrintName = "Half-Life Alyx Deathmatch"
...
util.AddNetworkString("hl2dm2_start")
...
function MODE:GiveEquipment()
	timer.Simple(0.1, function()
		...
		for _, ply in RandomPairs(players_alive) do
			...
			ply:SetPlayerClass(ply:Team() == 1 and "HLACombine" or "HLARebel")
