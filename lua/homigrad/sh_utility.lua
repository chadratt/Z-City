...
--\\ custom spawn
	...
	local hg_movement_runspeed = CreateConVar("hg_movement_runspeed", 390, FCVAR_REPLICATED + FCVAR_ARCHIVE + FCVAR_NOTIFY, "Changes run speed, old zcity default - 350", 0, 9999)
	local hg_movement_walkspeed = CreateConVar("hg_movement_walkspeed", 100, FCVAR_REPLICATED + FCVAR_ARCHIVE + FCVAR_NOTIFY, "Changes walk speed, old zcity default - 100", 0, 9999)
	local hg_movement_slowwalkspeed = CreateConVar("hg_movement_slowwalkspeed", 60, FCVAR_REPLICATED + FCVAR_ARCHIVE + FCVAR_NOTIFY, "Changes slowwalk speed, old zcity default - 60", 0, 9999)
	local hg_movement_ladderclimbspeed = CreateConVar("hg_movement_ladderclimbspeed", 150, FCVAR_REPLICATED + FCVAR_ARCHIVE + FCVAR_NOTIFY, "Changes leader climb speed, old zcity default - 150", 0, 9999)
